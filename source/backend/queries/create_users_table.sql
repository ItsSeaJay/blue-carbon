...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2017 at 12:52 PM
...
CREATE TABLE `users` (
  ...
  `e-mail` varchar(320) CHARACTER SET ascii NOT NULL
...
(1, 'root', '$2y$10$ZntRojQeHLUG7iFaqEQ8.uoywwzl15B7Kb6CwqEk.XY7hXDgAnrdO', 'root@example.com');
